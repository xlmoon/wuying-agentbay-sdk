...
"""
    ...
    def _create_browser_session(self, extension_ids: List[str]):
        ...
        This method demonstrates the legacy approach using individual parameters.
        For new code, consider using ExtensionOption parameter instead.
        """
        ...
        # Note: This uses the legacy approach with individual parameters
        # For new code, prefer using ExtensionOption parameter
        extentionOption = ExtensionOption(self.context_id,extension_ids)
        session_params = CreateSessionParams(
            ...
            browser_context=BrowserContext(
                ...
                auto_upload=True,
                extension_option=extentionOption
            ),
            is_vpc=False
        )
